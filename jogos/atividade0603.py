def receita():
    ...
    escolha = int(input("Defina uma receita: "))
    ...
    if(escolha == 1):
        ...
        print("Em uma frigideira larga e baixa, coloque a água com o vinagre e deixe ferver.\n")
        print("Desligue o fogo, quebre os ovos delicadamente dentro da água e tampe imediatamente.\n")
        print("Deixe por 4 minutos ou até as claras ficarem opacas.\n")
        print("Retire com uma escumadeira e coloque sobre um prato.\n")
        print("Tempere com sal e sirva em seguida.\n")

        print("Ingredientes\n")

        for item in zip(range(4), ['3 xícaras (chá) de água', '1 colher (sopa) de vinagre branco', '2 ovos', 'Sal a gosto']):
            print(f"{item}\n")
